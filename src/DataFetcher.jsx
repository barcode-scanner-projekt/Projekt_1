...
const DataFetcher = () => {
	...
	const fixedArray = studentArray.slice(
		Math.max(studentArray.length - 6, 0),
		studentArray.length
	);
	...
	return (
		<>
			<div
				className="w-full h-1/3 rounded-3xl text-white shadow-2xl p-5 backdrop-blur-md 
	  	bg-gradient-to-b from-black/40 to-fuchsia-800/50 shadow-fuchsia-950"
			>
			...
			<div
				className="rounded-3xl text-white shadow-2xl p-5 w-[200%] h-1/2 
	  	backdrop-blur-md bg-gradient-to-b from-black/40 to-fuchsia-800/50 shadow-fuchsia-950"
			>
